...
slider.addEventListener("input", (e) => {
    ...
    setPrint[1] = `border-radius: ${e.target.value}px`
    print(setPrint)
})
...
shadowX.addEventListener("input", (e) => {
    ...
    setPrint[3] = `box-shadow: ${e.target.value}px ${shadowY.value}px ${shadowBlur.value}px  ${shadowSpread.value}px ${shadowColour.value}`
    print(setPrint)
})
shadowY.addEventListener("input", (e) => {
    ...
    setPrint[3] = `box-shadow: ${shadowX.value}px ${e.target.value}px ${shadowBlur.value}px  ${shadowSpread.value}px ${shadowColour.value}`;
    print(setPrint)
})
shadowBlur.addEventListener("input", (e) => {
    box.style.boxShadow = `${shadowX.value}px ${shadowY.value}px ${e.target.value}px  ${shadowSpread.value}px ${shadowColour.value}`;
    setPrint[3] = `box-shadow: ${shadowX.value}px ${shadowY.value}px ${e.target.value}px  ${shadowSpread.value}px ${shadowColour.value}`;
    print(setPrint)
})
shadowSpread.addEventListener("input", (e) => {
    ...
    setPrint[3] = `box-shadow: ${shadowX.value}px ${shadowY.value}px ${shadowBlur.value}px  ${e.target.value}px ${shadowColour.value}`;
    print(setPrint)
})
shadowColour.addEventListener("input", (e) => {
    ...
    setPrint[3] = `box-shadow: ${shadowX.value}px ${shadowY.value}px ${shadowBlur.value}px  ${shadowSpread.value}px ${e.target.value}`;
    print(setPrint)
})
...
borderSize.addEventListener("input", (e) => {
    ...
    setPrint[2] = `border: ${e.target.value}px ${borderType} ${borderColour.value}`
    print(setPrint)
...
borderSlider.addEventListener("input", (e) => {
    ...
    setPrint[2] = `border: ${borderSize.value}px ${borderType} ${borderColour.value}`
    print(setPrint)
})

borderColour.addEventListener("input", (e) => {
    box.style.border = `${borderSize.value}px ${borderType} ${e.target.value}`
    setPrint[2] = `border: ${borderSize.value}px ${borderType} ${e.target.value}`
    print(setPrint)
})
...
borders.forEach((bt) => {
    bt.addEventListener("click", (e) => {
        ...
        setPrint[2] = `border: ${borderSize.value}px ${e.target.value} ${borderColour.value}`
        print(setPrint)
    })
})
...
function test(a,b,c,d,e)
{
     ...
     setPrint[0] = `background: linear-gradient(${e}deg, ${a} ${b}%, ${c} ${d}%)`
}
